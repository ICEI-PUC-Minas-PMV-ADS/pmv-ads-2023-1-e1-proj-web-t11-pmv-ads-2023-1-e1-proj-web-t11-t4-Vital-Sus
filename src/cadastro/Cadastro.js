      ...
      <div className="Cadastro">
        <div>
          <body>
            ...
            <main>
              <button><h3>Usuario</h3></button>
              <button><h3>Funcionario</h3></button>
              ...
              <form method="post">
                ...
                <input type="data" id="data-nascimento" name="data-nascimento" placeholder='00/00/0000' />
                <input type="text" id="cpf" name="cpf" placeholder="00000000000" /><br />
                ...
                <input type="tel" id="celular" name="celular" placeholder='(31)9xxx-xxxx' />
                <input type="tel" id="telefone" name="telefone" placeholder='(31)xxxx-xxxx' />
                ...
                <input type="text" id="complemento" name="complemento" placeholder='Ap-casa' />
                <input type="text" id="cidade" name="cidade" placeholder='Cidade/Estado' />
                <input type="text" id="pais" name="pais" placeholder='Pais' /><br></br>
                ...
                <label for="confirmar_senha">Confirmação da senha*</label><br></br>
