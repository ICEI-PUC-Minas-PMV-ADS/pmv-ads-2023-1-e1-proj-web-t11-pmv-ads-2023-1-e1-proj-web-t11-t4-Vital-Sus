export function validarFormulario() {
    ...
    const complemento = (document.getElementById('complemento') as HTMLInputElement).value.trim();
    ...
    const confirmarSenha = (document.getElementById('confirmar_senha') as HTMLInputElement).value.trim();
