    ...
    <>
      <TemplatePage>
        <div class="container cadastrar">
          ...
          >
            <Grid xs={6}>
              <ButtonVT model={'secundary'} label={'Usuario'}></ButtonVT>
            </Grid>
            <Grid xs={6}>
              <ButtonVT model={'secundary'} label={'Funcionario'}></ButtonVT>
            </Grid>
          </Grid>
          ...
          <Grid container rowspacing={2}>
            ...
            <Grid container rowspacing={2}>
              ...
              <Grid xs={4}>
                <ButtonVT type="submit" id="cadastrar" model={'primary'} label={'Cadastrar'}></ButtonVT>
              </Grid>
            </Grid>
          </Grid>
        </div>
